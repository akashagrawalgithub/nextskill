...
px-6 py-12 lg:px-8 bg-white">
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <img src="https://cliply.co/wp-content/uploads/2020/09/442008570_ARTIST_AVATAR_3D_400px.gif" height={100} width={100} />
            </div>
              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    required
                    className="block w-full rounded-md border-0 py-2 px-3 text-gray-900 
